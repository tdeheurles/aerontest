...
( 
    ...
    ./do --host --component="dependencies" --command="get_protoc"
    export PATH="${PATH}:${this_directory}/../binaries/protoc-${protoc_version}/bin"
    export PATH="${PATH}:${this_directory}/../binaries/protoc-${protoc_version}/include"
