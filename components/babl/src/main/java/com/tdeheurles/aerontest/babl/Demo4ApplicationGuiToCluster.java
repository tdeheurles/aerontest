...
public class Demo4ApplicationGuiToCluster implements Application {
    private final Long2ObjectHashMap<Session> sessions;
    private final AeronCluster aeronCluster;
    private final IdleStrategy idleStrategy;

    public Demo4ApplicationGuiToCluster(Long2ObjectHashMap<Session> sessions, AeronCluster aeronCluster, IdleStrategy idleStrategy) {
