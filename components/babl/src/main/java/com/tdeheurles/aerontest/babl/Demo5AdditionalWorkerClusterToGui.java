...
public class Demo5AdditionalWorkerClusterToGui implements Agent, EgressListener {
    private final Long2ObjectHashMap<Session> sessions;
    private AeronCluster aeronCluster;

    public Demo5AdditionalWorkerClusterToGui(Long2ObjectHashMap<Session> sessions) {
