...
public class Demo5Server {
    public static void main(String[] args) {
        ...
        final var additionalWorkClusterToGui = new Demo5AdditionalWorkerClusterToGui(sessions);
        ...
        try (
            ...
            final var applicationGuiToCluster = new Demo5ApplicationGuiToCluster(sessions, aeronCluster, idleStrategy);
